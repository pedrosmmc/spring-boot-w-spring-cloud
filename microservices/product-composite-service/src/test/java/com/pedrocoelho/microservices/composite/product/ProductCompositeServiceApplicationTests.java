...
class ProductCompositeServiceApplicationTests {
    ...
    void setUp() {
        ...
        when(productCompositeIntegration.getRecommendations(PRODUCT_ID_OK)).thenReturn(Collections.singletonList(new Recommendation(PRODUCT_ID_OK, 123, "author", 123, "content", "mock-address")));
        when(productCompositeIntegration.getReviews(PRODUCT_ID_OK)).thenReturn(Collections.singletonList(new Review(PRODUCT_ID_OK, 123, "author", "subject", "content", "mock-address")));
